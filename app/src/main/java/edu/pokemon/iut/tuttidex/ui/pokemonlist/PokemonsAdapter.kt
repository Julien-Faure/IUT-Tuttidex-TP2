...
import edu.pokemon.iut.tuttidex.ui.pokemondetail.PokemonDetailFragment
...
class PokemonsAdapter(viewModel: PokemonListViewModel?) : DataBindingAdapter<Pokemon, PokemonListViewModel>(DiffCallback(),viewModel){
    ...
    override fun onBindViewHolder(holder: DataBindingViewHolder<Pokemon, PokemonListViewModel>, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            holder.itemView.findNavController().navigate(PokemonListFragmentDirections.actionPokemonListFragmentToPokemonDetailFragment(getItem(holder.adapterPosition).number))
